                                             ...
                                             <table align="center" style="width:90%">
                                                ...
                                                <telerik:RadGrid ID="rdDinCount" GroupingSettings-CaseSensitive="false" Skin="WebBlue" AllowSorting="true" runat="server"
                                                    ...
                                                    <MasterTableView>
                                                        <CommandItemSettings ShowExportToCsvButton="true" />
                                                        <Columns>                                                                                                                                                                    
                                                           <telerik:GridBoundColumn HeaderText="Menu Item" HeaderStyle-Width="70px" DataField="ItemName" ReadOnly="true" FilterControlWidth="50px" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"></telerik:GridBoundColumn>
                                                            <telerik:GridBoundColumn HeaderText="Regular" HeaderStyle-Width="70px" DataField="Regular" ReadOnly="true" FilterControlWidth="50px" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right"></telerik:GridBoundColumn>  
                                                           <telerik:GridBoundColumn HeaderText="Guest" HeaderStyle-Width="70px" DataField="Casual/Guest" ReadOnly="true" FilterControlWidth="50px" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right"></telerik:GridBoundColumn>    
                                                           <telerik:GridBoundColumn HeaderText="H.Delivery" HeaderStyle-Width="70px" DataField="Home Delivery" ReadOnly="true" FilterControlWidth="50px" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right"></telerik:GridBoundColumn>                                                               
