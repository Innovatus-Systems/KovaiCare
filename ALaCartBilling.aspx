        ...
        <div class="first_cnt">
            ...
            <asp:UpdatePanel ID="UpPanel" runat="server">
                                                            ...
                                                            <table>
                                                               ...
                                                               <asp:ListItem Text="0" Value="0"></asp:ListItem>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                         <asp:TextBox ID="txtBMQuantity" runat="Server" MaxLength="12" ToolTip="How much to order per person?" Width="150px" Height="25px" ForeColor="Black" Font-Names="Verdana" Font-Size="Small" AutoPostBack="true" OnTextChanged="ddlBMQuantiry_SelectedIndexChanged"></asp:TextBox>
                                        ...
                                        <tr>
                                            <td>
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td class="auto-style1">
                                                            <telerik:RadGrid ID="rgBookingameal" AutoGenerateColumns="False" runat="server" AutoGenerateDeleteColumn="True" Width="417px" OnDeleteCommand="rgBookingameal_DeleteCommand" OnItemCommand="rgBookingameal_ItemCommand">
                                                                <MasterTableView DataKeyNames="RSN">
                                                                    <Columns>
                                                                        ...
                                                                        <telerik:GridTemplateColumn UniqueName="Person" HeaderText="Ct." Visible="false">
                                                                            <ItemTemplate>
                                                    ...
                                                    <tr>
                                                            ...
                                                            <telerik:RadGrid ID="RgItemDisplay" AutoGenerateColumns="False" runat="server" AutoGenerateDeleteColumn="True" Width="311px" OnDeleteCommand="rgBookingameal_DeleteCommand" OnItemCommand="rgBookingameal_ItemCommand">
                                                            </telerik:RadGrid>
                                                        </td>
                                                    </tr>
                                                </table>
                ...
                <Triggers>
                    ...
                    <asp:AsyncPostBackTrigger ControlID="txtBMQuantity" />
